...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {\resumeSubItem{Completed 1000+ hours of Java, Spring, SQL, and JavaScript training}
...
%-------------------------------------------
    ...
    \resumeSubheading
      {Crewmate}{2018 -- 2019}
      {Wendy's}{North Canton, OH}
      \resumeItemListStart
        \resumeItem{Maintained high cleanliness and health code standards.}
        \resumeItem{Delivered great service to every guest.}
        \resumeItem{Cross-trained in multiple positions to easily step in and fillneeds during busy periods.}
      \resumeItemListEnd
  \resumeSubHeadingListEnd
